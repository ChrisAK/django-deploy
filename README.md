...
This template contains a project, `django-auth-template-deploy`, and an app, `api`,
...
1. Replace all instances of `django-auth-template-deploy` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `django-auth-template-deploy` which should be renamed
...
all instances of `django-auth-template-deploy` with your app's name.
